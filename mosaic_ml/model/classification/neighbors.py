...
def get_configuration_KNeighborsClassifier():
    kNeighborsClassifier = ListTask(is_ordered=False, name = "KNeighborsClassifier",
    ...
    sampler = {
        "KNeighborsClassifier__n_neighbors": Parameter("KNeighborsClassifier__n_neighbors", [2, 30], "uniform", "int"),
         ...
         "KNeighborsClassifier__p": Parameter("KNeighborsClassifier__p", [1, 2, 3, 4, 5], "choice", "int"),
...
def get_configuration_RadiusNeighborsClassifier():
    RadiusNeighborsClassifier = ListTask(is_ordered=False, name = "RadiusNeighborsClassifier",
    ...
    rules = [ChildRule(applied_to = ["RadiusNeighborsClassifier__leaf_size"], parent = "RadiusNeighborsClassifier__algorithm", value = ["ball_tree", "kd_tree"]),
