...
def get_configuration_AdaBoostClassifier():
    ...
    sampler = {
          ...
          "AdaBoostClassifier__n_estimators": Parameter("AdaBoostClassifier__n_estimators", [1, 100], "uniform", "int"),
          "AdaBoostClassifier__learning_rate": Parameter("AdaBoostClassifier__learning_rate", [0.1, 5], "uniform", "float"),
...
def get_configuration_BaggingClassifier():
    ...
    sampler = {
          ...
          "BaggingClassifier__n_estimators": Parameter("BaggingClassifier__n_estimators", [1, 100], "uniform", "int"),
...
def get_configuration_ExtraTreesClassifier():
    ...
    sampler = {
             "ExtraTreesClassifier__n_estimators": Parameter("ExtraTreesClassifier__n_estimators", [1, 100], "uniform", "int"),
             ...
             "ExtraTreesClassifier__min_samples_split": Parameter("ExtraTreesClassifier__min_samples_split", [0.01, 0.2], "uniform", "float"),
             "ExtraTreesClassifier__min_samples_leaf": Parameter("ExtraTreesClassifier__min_samples_leaf", [0.01, 0.2], "uniform", "float"),
...
def get_configuration_GradientBoostingClassifier():
    ...
    sampler = {
             ...
             "GradientBoostingClassifier__learning_rate": Parameter("GradientBoostingClassifier__learning_rate", [0.001, 0.3], "uniform", "float"),
             "GradientBoostingClassifier__n_estimators": Parameter("GradientBoostingClassifier__n_estimators", [1, 100], "uniform", "int"),
             ...
             "GradientBoostingClassifier__min_samples_split": Parameter("GradientBoostingClassifier__min_samples_split", [0.01, 0.2], "uniform", "float"),
             "GradientBoostingClassifier__min_samples_leaf": Parameter("GradientBoostingClassifier__min_samples_leaf", [0.01, 0.2], "uniform", "float"),
             ...
             "GradientBoostingClassifier__subsample": Parameter("GradientBoostingClassifier__subsample", [0.8, 1], "uniform", "float"),
...
def get_configuration_RandomForestClassifier():
    ...
    sampler = {
             "RandomForestClassifier__n_estimators": Parameter("RandomForestClassifier__n_estimators", [1, 100], "uniform", "int"),
             "RandomForestClassifier__criterion": Parameter("RandomForestClassifier__criterion", ["gini", "entropy"], "choice", "string"),
             "RandomForestClassifier__max_depth": Parameter("RandomForestClassifier__max_depth", [1, 10], "uniform", "int"),
             "RandomForestClassifier__min_samples_split": Parameter("RandomForestClassifier__min_samples_split", [0.01, 0.2], "uniform", "float"),
             "RandomForestClassifier__min_samples_leaf": Parameter("RandomForestClassifier__min_samples_leaf", [0.01, 0.2], "uniform", "float"),
