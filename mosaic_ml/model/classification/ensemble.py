...
def get_configuration_ExtraTreesClassifier():
    ...
    sampler = {
             ...
             "ExtraTreesClassifier__min_samples_leaf": Parameter("ExtraTreesClassifier__min_samples_leaf", [1, 20], "uniform", "float"),
...
def get_configuration_GradientBoostingClassifier():
    ...
    sampler = {
             ...
             "GradientBoostingClassifier__min_samples_leaf": Parameter("GradientBoostingClassifier__min_samples_leaf", [1, 20], "uniform", "float"),
...
def get_configuration_RandomForestClassifier():
    ...
    sampler = {
             ...
             "RandomForestClassifier__min_samples_leaf": Parameter("RandomForestClassifier__min_samples_leaf", [1, 20], "uniform", "float"),
