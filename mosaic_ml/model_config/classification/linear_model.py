...
def get_configuration_LogisticRegression():
    logisticRegression = WorkflowListTask(is_ordered=False, name = "LogisticRegression",
...
def get_configuration_SGDClassifier():
    sgdClassifier = WorkflowListTask(is_ordered=False, name = "SGDClassifier",
...
def get_configuration_RidgeClassifier():
    ridgeClassifier = WorkflowListTask(is_ordered=False, name = "RidgeClassifier",
...
def get_configuration_Perceptron():
    perceptron = WorkflowListTask(is_ordered=False, name = "Perceptron",
...
def get_configuration_PassiveAggressiveClassifier():
    passiveAggressiveClassifier = WorkflowListTask(is_ordered=False, name = "PassiveAggressiveClassifier",
