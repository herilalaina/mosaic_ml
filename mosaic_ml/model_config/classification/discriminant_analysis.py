...
def get_configuration_LinearDiscriminantAnalysis():
    LinearDiscriminantAnalysis = WorkflowListTask(is_ordered=False, name = "LinearDiscriminantAnalysis",
...
def get_configuration_QuadraticDiscriminantAnalysis():
    QuadraticDiscriminantAnalysis = WorkflowListTask(is_ordered=False, name = "QuadraticDiscriminantAnalysis",
