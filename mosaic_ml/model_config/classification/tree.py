...
def get_configuration_DecisionTreeClassifier():
    DecisionTreeClassifier = WorkflowListTask(is_ordered=False, name = "DecisionTreeClassifier",
...
def get_configuration_ExtraTreeClassifier():
    ExtraTreeClassifier = WorkflowListTask(is_ordered=False, name = "ExtraTreeClassifier",
