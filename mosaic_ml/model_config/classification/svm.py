...
def get_configuration_LinearSVC():
    LinearSVC = WorkflowListTask(is_ordered=False, name = "LinearSVC",
...
def get_configuration_NuSVC():
    NuSVC = WorkflowListTask(is_ordered=False, name = "NuSVC",
                                  tasks = ["NuSVC__nu",
                                           "NuSVC__kernel",
                                           "NuSVC__degree",
                                           "NuSVC__gamma",
...
def get_configuration_SVC():
    ...
    SVC = WorkflowListTask(is_ordered=False, name = "SVC",
                                  tasks = ["SVC__C",
                                           "SVC__kernel",
                                           "SVC__degree",
                                           "SVC__gamma",
