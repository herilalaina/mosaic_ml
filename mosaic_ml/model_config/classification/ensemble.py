...
from mosaic.simulation.rules import ValueRule

from sklearn.tree import DecisionTreeClassifier


def get_configuration_AdaBoostClassifier():
    AdaBoostClassifier = WorkflowListTask(is_ordered=False, name = "AdaBoostClassifier",
...
def get_configuration_BaggingClassifier():
    BaggingClassifier = WorkflowListTask(is_ordered=False, name = "BaggingClassifier",
...
def get_configuration_ExtraTreesClassifier():
    ExtraTreesClassifier = WorkflowListTask(is_ordered=False, name = "ExtraTreesClassifier",
...
def get_configuration_GradientBoostingClassifier():
    GradientBoostingClassifier = WorkflowListTask(is_ordered=False, name = "GradientBoostingClassifier",
...
def get_configuration_RandomForestClassifier():
    RandomForestClassifier = WorkflowListTask(is_ordered=False, name = "RandomForestClassifier",
