...
def get_configuration_SelectPercentile():
    SelectPercentile = WorkflowListTask(is_ordered=False, name = "SelectPercentile",
...
def get_configuration_SelectFpr():
    SelectFpr = WorkflowListTask(is_ordered=False, name = "SelectFpr",
...
def get_configuration_SelectFdr():
    SelectFdr = WorkflowListTask(is_ordered=False, name = "SelectFdr",
...
def get_configuration_SelectFwe():
    SelectFwe = WorkflowListTask(is_ordered=False, name = "SelectFwe",
...
def get_configuration_SelectFromModel():
    SelectFromModel = WorkflowListTask(is_ordered=False, name = "SelectFromModel",
...
def get_configuration_ExtraTreesClassifierPrep():
    ExtraTreesClassifierPrep = WorkflowListTask(is_ordered=False, name = "ExtraTreesClassifierPrep",
...
def get_configuration_RFE():
    RFE = WorkflowListTask(is_ordered=False, name = "RFE",
