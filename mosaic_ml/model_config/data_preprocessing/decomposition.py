...
def get_configuration_DictionaryLearning():
    DictionaryLearning = WorkflowListTask(is_ordered=False, name = "DictionaryLearning",
...
def get_configuration_FactorAnalysis():
    ...
    FactorAnalysis = WorkflowListTask(is_ordered=False, name = "FactorAnalysis",
...
def get_configuration_FastICA():
    FastICA = WorkflowListTask(is_ordered=False, name = "FastICA",
...
def get_configuration_IncrementalPCA():
    IncrementalPCA = WorkflowListTask(is_ordered=False, name = "IncrementalPCA",
...
def get_configuration_KernelPCA():
    ...
    KernelPCA = WorkflowListTask(is_ordered=False, name = "KernelPCA",
...
def get_configuration_LatentDirichletAllocation():
    LatentDirichletAllocation = WorkflowListTask(is_ordered=False, name = "LatentDirichletAllocation",
...
def get_configuration_MiniBatchDictionaryLearning():
    MiniBatchDictionaryLearning = WorkflowListTask(is_ordered=False, name = "MiniBatchDictionaryLearning",
...
def get_configuration_MiniBatchSparsePCA():
    MiniBatchSparsePCA = WorkflowListTask(is_ordered=False, name = "MiniBatchSparsePCA",
...
def get_configuration_NMF():
    ...
    NMF = WorkflowListTask(is_ordered=False, name = "NMF",
