...
def get_model(name, config, random_state):
    model = PolynomialFeatures(
        degree=config["feature_preprocessor:polynomial:degree"],
        include_bias=config["feature_preprocessor:polynomial:include_bias"],
        interaction_only=config["feature_preprocessor:polynomial:interaction_only"],
