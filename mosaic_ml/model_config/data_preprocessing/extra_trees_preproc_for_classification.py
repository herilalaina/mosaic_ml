...
def get_model(name, config):
    model = SelectFromModel(
        estimator=ExtraTreesClassifier(
            ...
            max_leaf_nodes=None,
            min_impurity_decrease=float(config["preprocessor:extra_trees_preproc_for_classification:min_impurity_decrease"]),
            ...
            min_weight_fraction_leaf=float(config["preprocessor:extra_trees_preproc_for_classification:min_weight_fraction_leaf"]),
